...
export default function FloatingActionBar() {
  return (
    <div
      ...
      className="fixed bottom-4 right-4 sm:right-6 z-50 flex items-center gap-2 bg-ink-black/95 text-paper-cream px-3 py-2 rounded-full shadow-lg border-2 border-paper-tan backdrop-blur-sm select-none"
    >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        title="Git Repository Telegraph"
